...
def summarize_text(text, api_key):
    try:
        ...
        messages = [UserMessage(content=f"Generate a new and concise summary of this text:\n{text}")]
    ...
    if uploaded_pdf and user_api_key:
        ...
        if audio_path:
            ...
            with open(audio_path, "rb") as audio_file:
                st.download_button(label="Download MP3", data=audio_file, file_name="summary.mp3", mime="audio/mp3")
        else:
